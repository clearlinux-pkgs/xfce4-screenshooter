...
Version  : 1.11.0
Release  : 34
URL      : https://archive.xfce.org/src/apps/xfce4-screenshooter/1.11/xfce4-screenshooter-1.11.0.tar.bz2
Source0  : https://archive.xfce.org/src/apps/xfce4-screenshooter/1.11/xfce4-screenshooter-1.11.0.tar.bz2
...
%prep
%setup -q -n xfce4-screenshooter-1.11.0
cd %{_builddir}/xfce4-screenshooter-1.11.0
pushd ..
cp -a xfce4-screenshooter-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721929197
