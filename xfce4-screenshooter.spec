...
Source0  : https://archive.xfce.org/src/apps/xfce4-screenshooter/1.10/xfce4-screenshooter-1.10.5.tar.bz2
...
%prep
%setup -q -n xfce4-screenshooter-1.10.5
cd %{_builddir}/xfce4-screenshooter-1.10.5
pushd ..
cp -a xfce4-screenshooter-1.10.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707154555
