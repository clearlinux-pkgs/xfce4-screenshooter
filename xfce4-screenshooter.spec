...
Source0  : https://archive.xfce.org/src/apps/xfce4-screenshooter/1.10/xfce4-screenshooter-1.10.2.tar.bz2
...
%prep
%setup -q -n xfce4-screenshooter-1.10.2
cd %{_builddir}/xfce4-screenshooter-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672695736
