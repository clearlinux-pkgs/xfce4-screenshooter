...
Source0  : http://archive.xfce.org/src/apps/xfce4-screenshooter/1.9/xfce4-screenshooter-1.9.7.tar.bz2
...
%prep
%setup -q -n xfce4-screenshooter-1.9.7
cd %{_builddir}/xfce4-screenshooter-1.9.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572992697
...
cp %{_builddir}/xfce4-screenshooter-1.9.7/COPYING %{buildroot}/usr/share/package-licenses/xfce4-screenshooter/73ccddd0c27b4492f8182c35f0f7c434b998757c
%make_install
