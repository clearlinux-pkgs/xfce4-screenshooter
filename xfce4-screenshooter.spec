...
Source0  : https://archive.xfce.org/src/apps/xfce4-screenshooter/1.10/xfce4-screenshooter-1.10.6.tar.bz2
...
%prep
%setup -q -n xfce4-screenshooter-1.10.6
cd %{_builddir}/xfce4-screenshooter-1.10.6
pushd ..
cp -a xfce4-screenshooter-1.10.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717014855
